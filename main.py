"""FOL — Identity Pipeline orchestrator (Layers 1-4)."""
...
def _run_full_pipeline(no_cache: bool, dry_run: bool) -> None:
    ...
    if not dry_run:
        ...
        from utils.episodic_writer import EPISODIC_PATH
...
def main() -> None:
    parser = argparse.ArgumentParser(description="FOL — Layer 1 Identity Pipeline")
